...
# with open('z/output/output1.txt', 'r', encoding='utf-8') as f:
#     columns = f.read().strip().split(', ')

# # Чтение данных из output2.txt
# data = pd.read_csv('z/output/output0.txt', delimiter='\t')  # Предполагается, что данные разделены табуляцией

# # Чтение шаблона XML
# with open('z/input/input.xml', 'r', encoding='utf-8') as f:
#     xml_template = f.read()
